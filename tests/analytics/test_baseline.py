...
class TestBaselineFromFeatures:
    ...
    def test_from_features_basic(
        self, normal_hrv_features, excellent_hrv_features, poor_hrv_features
    ):
...
class TestBaselineStatistics:
    ...
    def test_get_recent_multiple_calls(self, baseline_7days):
        ...
        assert all(
            r1.rmssd == r2.rmssd for r1, r2 in zip(recent1, recent2, strict=False)
        )
