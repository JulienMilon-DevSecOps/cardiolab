...
from cardiolab.protocols.hrr import HRRResult, _categorise_hrr1, _categorise_hrr2, heart_rate_recovery
...
class TestHRRResult:
    ...
    def test_to_dict_keys(self):
        r = HRRResult()
        expected = {
            "date", "hr_peak", "hr_at_60s", "hr_at_120s",
            "hrr_60", "hrr_120", "hrr_60_category", "hrr_120_category", "duration",
        }
...
class TestHeartRateRecovery:
    ...
    def test_2min_recording_has_hrr2(self):
        ...
        if not math.isnan(result.hrr_120):
            ...
            assert result.hrr_120_category in ("excellent", "good", "normal", "impaired")
